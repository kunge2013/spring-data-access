...
public class NumberValidationUtil {
    ...
    public static boolean isNum(String numStr) {
        boolean res = isNumeric(numStr) || isDecimal(numStr)
                || isInteger(numStr) || isNegativeDecimal(numStr)
                || isPositiveDecimal(numStr) || isPositiveRealNumber(numStr)
                || isRealNumber(numStr) || isNonNegativeRealNumber(numStr) || isNegativeInteger(numStr);
        return res;
    }
}
